...
<body class="dashboard-page sb-l-o sb-r-c">
    ...
    <?php $this->load->view('private/themer')?>
    ...
    <!-- Chart Plugins -->
    <script type="text/javascript" src="<?=base_url()?>assets/vendor/plugins/highcharts/highcharts.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/vendor/plugins/circles/circles.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/vendor/plugins/raphael/raphael.js"></script>

    <!-- Holder js  -->
    <script type="text/javascript" src="<?=base_url()?>assets/assets/js/bootstrap/holder.min.js"></script>
    ...
    <!-- Admin Panels  -->
    <script type="text/javascript" src="<?=base_url()?>assets/assets/admin-tools/admin-plugins/admin-panels/json2.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/assets/admin-tools/admin-plugins/admin-panels/jquery.ui.touch-punch.min.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/assets/admin-tools/admin-plugins/admin-panels/adminpanels.js"></script>

    <!-- Page Javascript -->
    <script type="text/javascript" src="<?=base_url()?>assets/assets/js/pages/widgets.js"></script>
